...
## Project Structure
    ...
    ├── ideapros_exp_horizo_33807  # Django project configurations
...
1. Clone this repo and `cd ideapros_exp_horizo_33807`
...
2. Clone this repo and `cd ideapros_exp_horizo_33807`
